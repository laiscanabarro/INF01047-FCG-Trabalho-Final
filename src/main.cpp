...
float g_CameraDistance = 240.0f; // Dist�ncia da c�mera para a origem
...
*/
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        float farplane  = -10000.0f; // Posi��o do "far plane"
        ...
        float tamanhoSol = 28.0f; // Tamanho: 1.400.000 KM (O sol ter� que ser diminuido 98% de tamanho para caber na proje��o)
